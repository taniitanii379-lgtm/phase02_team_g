    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                {{-- 新規作成リンク --}}
                <div class="mb-4">
                    <a href="{{ route('quizzes.create') }}" class="text-blue-600 hover:underline">+ 新しいクイズを作成</a>
                </div>
                    ...
                    <tbody>
                        @forelse ($quizzes as $quiz)
                            <tr>
                                ...
                                <td class="border px-4 py-2">{{ $quiz->choices[$quiz->answer] ?? '不明' }}</td>
                                <td class="border px-4 py-2">
                                    <a href="{{ route('quizzes.edit', $quiz->id) }}" class="text-blue-500 hover:underline">編集</a>
                                    |
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center text-gray-500 py-4">クイズがまだ登録されていません。</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
